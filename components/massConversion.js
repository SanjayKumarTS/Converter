...
function mgInput()
{
    ...
    var lb = kg * 2.205;
    var t = kg / 1000 ;
    document.getElementById("mg").parentNode.style.display = "none";
...
function gInput()
{
    ...
    var lb = kg * 2.205;
    var t = kg / 1000 ;
    document.getElementById("g").parentNode.style.display = "none";
...
function kgInput()
{
    ...
    document.getElementById("kg").parentNode.style.display = "none";
    document.getElementById("mg").innerHTML = mg;
    document.getElementById("g").innerHTML = g;
    document.getElementById("lb").innerHTML = lb;
    document.getElementById("t").innerHTML = t;
...
function tInput()
{
    ...
    var mg = g * 1000;
    var lb = kg * 2.205
    document.getElementById("t").parentNode.style.display = "none";
    document.getElementById("mg").innerHTML = mg;
    document.getElementById("g").innerHTML = g;
    document.getElementById("kg").innerHTML = kg;
    document.getElementById("lb").innerHTML = lb;
...
function unitChange()
{
    ...
    switch(inputUnit)
    {
        case "mg": mgInput();break;
        case "g": gInput();break;
        case "kg": kgInput();break;
        case "lb": lgInput();break;
        case "t": tInput();break;
    }
}