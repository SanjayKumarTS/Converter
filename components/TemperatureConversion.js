...
function celciusInput()
{
    ...
    document.getElementById("celcius").parentNode.style.display = "none";
...
function fahrenheitInput()
{
    ...
    document.getElementById("fahrenheit").parentNode.style.display = "none";
...
function kelvinInput()
{
    ...
    document.getElementById("kelvin").parentNode.style.display = "none";
    document.getElementById("celcius").innerHTML = celcius;
    document.getElementById("fahrenheit").innerHTML = fahrenheit;
}
...
function unitChange()
{
    ...
    switch(inputUnit)
    {
        case "celcius": celciusInput();break;
        case "fahrenheit": fahrenheitInput();break;
        case "kelvin": kelvinInput();break;
    }
}