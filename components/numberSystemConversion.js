...
function binaryInput()
{
    ...
    document.getElementById("binary").parentNode.style.display = "none";
...
function octalInput()
{
    ...
    var hexadecimal = decimal.toString(16);
    document.getElementById("octal").parentNode.style.display = "none";
...
function decimalInput()
{
    ...
    document.getElementById("decimal").parentNode.style.display = "none";
    document.getElementById("binary").innerHTML = binary;
    document.getElementById("octal").innerHTML = octal;
    document.getElementById("hexadecimal").innerHTML = hexadecimal;
}
...
function hexadecimalInput()
{
    ...
    var binary = decimal.toString(2);
    var octal = decimal.toString(8);
    document.getElementById("hexadecimal").parentNode.style.display = "none";
    document.getElementById("binary").innerHTML = binary;
    document.getElementById("octal").innerHTML = octal;
    document.getElementById("decimal").innerHTML = decimal;
}
...
function unitChange()
{
    ...
    switch(inputUnit)
    {
        case "binary": binaryInput();break;
        case "octal": octalInput();break;
        case "decimal": decimalInput();break;
        case "hexadecimal": hexadecimalInput();break;
    }
}