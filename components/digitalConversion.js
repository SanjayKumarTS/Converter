...
function bInput() {
  ...
  var GB = MB / 1000;
  var TB = TB / 1000;
  document.getElementById("b").innerHTML = Number(inputValue);
...
function KBInput() {
  ...
  var GB = MB / 1000;
  var TB = TB / 1000;
  document.getElementById("KB").innerHTML = Number(inputValue);
  document.getElementById("b").innerHTML = b;
  document.getElementById("B").innerHTML = B;
  document.getElementById("MB").innerHTML = MB;
  document.getElementById("GB").innerHTML = GB;
...
function MBInput() {
  ...
  var GB = KB / 1048.576;
  var TB = TB / 1000;
  document.getElementById("MB").innerHTML = Number(inputValue);
  document.getElementById("b").innerHTML = b;
  document.getElementById("B").innerHTML = B;
  document.getElementById("KB").innerHTML = KB;
  document.getElementById("GB").innerHTML = GB;
...
function GBInput() {
  ...
  var MB = KB / 1048.576;
  var TB = MB / 1000000;
  document.getElementById("GB").innerHTML = Number(inputValue);
  document.getElementById("b").innerHTML = b;
  document.getElementById("B").innerHTML = B;
  document.getElementById("KB").innerHTML = KB;
  document.getElementById("MB").innerHTML = MB;
...
function TBInput() {
  ...
  var MB = KB / 1048.576;
  var GB = MB / 1000000;
  document.getElementById("TB").innerHTML = Number(inputValue);
  document.getElementById("b").innerHTML = b;
  document.getElementById("B").innerHTML = B;
  document.getElementById("KB").innerHTML = KB;
  document.getElementById("MB").innerHTML = MB;
