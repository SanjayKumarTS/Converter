...
function inch2Input() {
  ...
  document.getElementById("inch2").innerHTML = Number(inputValue);
...
function m2Input() {
  ...
  document.getElementById("m2").innerHTML = Number(inputValue);
...
function ft2Input() {
  ...
  document.getElementById("ft2").innerHTML = Number(inputValue);
  document.getElementById("m2").innerHTML = m2;
  document.getElementById("inch2").innerHTML = inch2;
  document.getElementById("km2").innerHTML = km2;
  document.getElementById("acre").innerHTML = acre;
...
function km2Input() {
  ...
  document.getElementById("km2").innerHTML = Number(inputValue);
  document.getElementById("m2").innerHTML = m2;
  document.getElementById("inch2").innerHTML = inch2;
  document.getElementById("ft2").innerHTML = ft2;
  document.getElementById("acre").innerHTML = acre;
...
function acreInput() {
  ...
  document.getElementById("acre").innerHTML = Number(inputValue);
  document.getElementById("m2").innerHTML = m2;
  document.getElementById("inch2").innerHTML = inch2;
  document.getElementById("ft2").innerHTML = ft2;
  document.getElementById("km2").innerHTML = km2;
...
function hectareInput() {
  ...
  document.getElementById("hectare").innerHTML = Number(inputValue);
  document.getElementById("m2").innerHTML = m2;
  document.getElementById("inch2").innerHTML = inch2;
  document.getElementById("ft2").innerHTML = ft2;
  document.getElementById("acre").innerHTML = acre;
