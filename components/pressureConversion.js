...
function atmInput()
{
    ...
    var bar = Number(inputValue) / 100000;
    var torr = Number(inputValue) / 133.322;
    document.getElementById("atm").parentNode.style.display = "none";
...
function torrInput()
{
    ...
    document.getElementById("torr").parentNode.style.display = "none";
    document.getElementById("pa").innerHTML = pa;
    document.getElementById("atm").innerHTML = atm;
    document.getElementById("bar").innerHTML = bar;
}
...
function unitChange()
{
    ...
    switch(inputUnit)
    {
        case "pa": paInput();break;
        case "atm": atmInput();break;
        case "torr": torrInpur();break;
        case "bar": barInput();break;
    }
}